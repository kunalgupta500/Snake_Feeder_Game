...
public class GamePlay extends JPanel implements KeyListener, ActionListener {
 ...
 public void paint(Graphics g){
  ...
  //draw title image
     ImageIcon titleImage= new ImageIcon("C:\\Users\\user\\IdeaProjects\\snak_game\\src\\title.png");
  ...
  headRight = new ImageIcon("C:\\Users\\user\\IdeaProjects\\snak_game\\src\\headRight.png");
  ...
  for(int i=0; i< lengthofsnake; i++)
  {
   ...
   if(i==0 && left)
   {
    headLeft = new ImageIcon("C:\\Users\\user\\IdeaProjects\\snak_game\\src\\headLeft.png");
    headLeft.paintIcon(this,g,snakeXlength[i],snakeYlength[i]);
   }
   if(i==0 && down)
   {
    headDown = new ImageIcon("C:\\Users\\user\\IdeaProjects\\snak_game\\src\\headDown.png");
    headDown.paintIcon(this,g,snakeXlength[i],snakeYlength[i]);
   }
   if(i==0 && up)
   {
    headUp = new ImageIcon("C:\\Users\\user\\IdeaProjects\\snak_game\\src\\headUp.png");
    headUp.paintIcon(this,g,snakeXlength[i],snakeYlength[i]);
   }
   if(i!=0)
   {
    tail = new ImageIcon("C:\\Users\\user\\IdeaProjects\\snak_game\\src\\tail.png");
    tail.paintIcon(this,g,snakeXlength[i],snakeYlength[i]);
   }
  }

  fruitimage = new ImageIcon("C:\\Users\\user\\IdeaProjects\\snak_game\\src\\fruit.png");
